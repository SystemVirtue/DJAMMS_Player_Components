...
import { ComingUpTicker } from './ComingUpTicker';
...
interface FullscreenPlayerProps {
  ...
  priorityQueue?: Video[]; // Priority queue for Coming Up ticker
  activeQueue?: Video[]; // Active queue for Coming Up ticker
  queueIndex?: number; // Current queue index for Coming Up ticker
}
    ...
    <div style={{
      ...
      {overlaySettings?.showComingUp && (
        <ComingUpTicker
          ...
          maxActiveItems={3}
          positionX={overlaySettings.comingUpX}
          positionY={overlaySettings.comingUpY}
          size={overlaySettings.comingUpSize}
          opacity={overlaySettings.comingUpOpacity}
        />
      )}
